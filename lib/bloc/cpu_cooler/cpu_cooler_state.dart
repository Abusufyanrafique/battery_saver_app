...
class CpuCoolerState extends Equatable {
  ...
  bool get isLoading     => status == CpuCoolerStatus.initial;
  bool get isError       => status == CpuCoolerStatus.error;
  ...
  List<Object?> get props => [
    status, cpuUsage, runningApps,
    temperature, statusMessage, errorMessage,
  ];
}